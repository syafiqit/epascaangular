...
@Component({
  selector: 'app-laporan-belum-terima-bantuan',
  templateUrl: './laporan-belum-terima-bantuan.component.html'
})
export class LaporanBelumTerimaBantuanComponent implements OnInit {
  ...
  readonly DELIMITER = '-';
	...
	rows = [
      ...
      daerah: 'KOTA SETAR', negeri: 'KEDAH'
		}
	];
